...
- New Mako: templates=0, lines=0, statements=0, code_tags=0, expressions=0, score=0
...
- `server/fishtest/templates_mako` currently contains no templates, so new Mako totals are zero.
