...
**Key remaining gap:** 23 out of 25 comparable templates still produce HTML diffs between Jinja2 and legacy Mako. Only `elo_results.html.j2` and `pagination.html.j2` match cleanly. The diffs are primarily whitespace, attribute ordering, and safe HTML entity differences — not functional regressions — but they prevent fully automated parity verification.
...
Only `elo_results.html.j2` and `pagination.html.j2` produce identical normalized HTML to their Mako counterparts. The other 23 templates differ due to:
...
| # | Template | Extension | Lines (approx) | Parity Status |
|---|----------|-----------|-------|---------------|
| 1 | `actions` | `.html.j2` / `.mak` | ~200 | Differs |
| 2 | `base` | `.html.j2` / `.mak` | ~300 | Differs |
| 3 | `contributors` | `.html.j2` / `.mak` | ~150 | Differs |
| 4 | `elo_results` | `.html.j2` / `.mak` | ~30 | **Matches** |
| 5 | `login` | `.html.j2` / `.mak` | ~50 | Differs |
| 6 | `machines` | `.html.j2` / `.mak` | ~150 | Differs |
| 7 | `nn_upload` | `.html.j2` / `.mak` | ~100 | Differs |
| 8 | `nns` | `.html.j2` / `.mak` | ~100 | Differs |
| 9 | `notfound` | `.html.j2` / `.mak` | ~20 | Differs |
| 10 | `pagination` | `.html.j2` / `.mak` | ~30 | **Matches** |
| 11 | `rate_limits` | `.html.j2` / `.mak` | ~50 | Differs |
| 12 | `run_table` | `.html.j2` / `.mak` | ~200 | Differs |
| 13 | `run_tables` | `.html.j2` / `.mak` | ~100 | Differs |
| 14 | `signup` | `.html.j2` / `.mak` | ~80 | Differs |
| 15 | `sprt_calc` | `.html.j2` / `.mak` | ~200 | Differs |
| 16 | `tasks` | `.html.j2` / `.mak` | ~150 | Differs |
| 17 | `tests` | `.html.j2` / `.mak` | ~200 | Differs |
| 18 | `tests_finished` | `.html.j2` / `.mak` | ~100 | Differs |
| 19 | `tests_live_elo` | `.html.j2` / `.mak` | ~150 | Differs |
| 20 | `tests_run` | `.html.j2` / `.mak` | ~400 | Differs |
| 21 | `tests_stats` | `.html.j2` / `.mak` | ~200 | Differs |
| 22 | `tests_user` | `.html.j2` / `.mak` | ~100 | Differs |
| 23 | `tests_view` | `.html.j2` / `.mak` | ~400 | Differs |
| 24 | `user` | `.html.j2` / `.mak` | ~100 | Differs |
| 25 | `user_management` | `.html.j2` / `.mak` | ~100 | Differs |
| 26 | `workers` | `.html.j2` / `.mak` | ~100 | Differs |
