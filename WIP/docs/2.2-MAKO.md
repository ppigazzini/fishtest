...
- New Mako and Jinja2 outputs are validated against legacy Mako with normalized parity checks.
...
- Renderer selection is a Python runtime switch (no environment flags).
...
- Metrics: [WIP/docs/8-TEMPLATE-METRICS.md](WIP/docs/8-TEMPLATE-METRICS.md)
