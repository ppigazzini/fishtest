...
| `compare_jinja_mako_new_parity.py` | Jinja2 vs new Mako parity runner (wraps the core) |
...
WIP/tools/compare_jinja_mako_new_parity.py
...
#### 7.3.6 Improve `compare_jinja_mako_new_parity.py` to run without subprocess (done - to be reviewed)

Currently, `compare_jinja_mako_new_parity.py` shells out to `compare_template_parity.py` via `subprocess.call()`. This:
