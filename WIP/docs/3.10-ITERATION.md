...
- 2026-02-08: Parity runs with the new WIP/tools render path still report normalized diffs for most templates; only `elo_results.mak` and `pagination.mak` match cleanly.
