...
- [x] Update `WIP/docs/8-TEMPLATE-METRICS.md` if diffs materially change output size or render time. (2026-02-08)
...
- [x] Replace manual static token LRU with `@lru_cache`. (2026-02-09)
...
- 2026-02-09: Urls-dict parity check added; `/workers/show` flagged as missing in current routes.
- 2026-02-09: `url_for` shadowing removed from base context; static token cache now uses `@lru_cache`.
