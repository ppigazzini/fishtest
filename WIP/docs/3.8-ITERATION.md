...
- Metrics doc: [WIP/docs/8-TEMPLATE-METRICS.md](WIP/docs/8-TEMPLATE-METRICS.md)
...
Deliverables:
- Metrics snapshot recorded in [WIP/docs/8-TEMPLATE-METRICS.md](WIP/docs/8-TEMPLATE-METRICS.md).
