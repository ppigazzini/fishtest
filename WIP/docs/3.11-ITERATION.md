...
Date: 2026-02-11
Status: Phase 7 complete — verification done (non-Mongo suite OK; template parity normalized OK; template coverage Jinja OK)
...
- Added `WIP/tools/run_nonmongo_tests.sh` to run the non-MongoDB test subset.
