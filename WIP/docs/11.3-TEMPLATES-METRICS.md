...
## HTML parity snapshot (2026-02-10)
...
Validation:
- Re-run after parity/lint verification (2026-02-10); values unchanged.

Notes on normalization:
- The normalization layer handles known deterministic differences between legacy
  Mako and idiomatic Jinja2 output: `document.title` scripts → `<title>` tag,
