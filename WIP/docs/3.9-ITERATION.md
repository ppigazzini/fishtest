...
- Added [WIP/tools/compare_jinja_mako_new_parity.py](WIP/tools/compare_jinja_mako_new_parity.py).
...
- Parity runs: `compare_jinja_mako_new_parity.py` OK, `compare_template_response_parity.py` OK (normalized).
...
- Parity runs: `compare_jinja_mako_new_parity.py` OK (normalized response parity).
...
- Parity runs (2026-02-06):
	...
	- `compare_jinja_mako_new_parity.py` OK (25 templates, normalized)
