    ...
    def test_build_tests_view_open_graph_uses_supplied_results_info(self):
        ...
        self.assertEqual(
            open_graph,
            {
                ...
                "description": "Synthetic ELO +/- line | Synthetic total",
                "url": "https://example.org/tests/view/69d12ae19caf4559aa7ada3e",
            },
        )
        self.assertEqual(theme_color, "#FFFF00")

    def test_build_tests_view_open_graph_adds_plain_text_pentanomial_summary(self):
        run = {
        ...
        self.assertNotIn("Ptnml(0-2):", open_graph["description"])
