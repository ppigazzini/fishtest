                ...
                <div class="col-6 col-md-3">
                  <div class="mb-2">
                    ...
                    <input
                      ...
                      id="spsa_sf_lr"
                      class="form-control"
                      value="${args.get('spsa', {}).get('sf_lr', '0.0025')}"
                    >
                  </div>
                </div>
                <div class="col-6 col-md-3">
                  <div class="mb-2">
                    <label for="spsa_sf_beta1" class="form-label">Beta 1</label>
                    <input
                      type="number"
                      min="0"
                      max="1"
                      ...
                      id="spsa_sf_beta1"
                      class="form-control"
                      value="${args.get('spsa', {}).get('sf_beta1', '0.90')}"
                    >
                  </div>
                </div>
                <div class="col-6 col-md-3">
                  <div class="mb-2">
                    <label for="spsa_sf_beta2" class="form-label">Beta 2</label>
                    <input
                      type="number"
                      min="0"
                      max="1"
                      ...
                      id="spsa_sf_beta2"
                      class="form-control"
                      value="${args.get('spsa', {}).get('sf_beta2', '0.999')}"
                    >
                  </div>
                </div>
                <div class="col-6 col-md-3">
                  <div class="mb-2">
                    <label for="spsa_sf_eps" class="form-label">Epsilon</label>
                    <input
                      type="number"
                      min="0"
                      max="1"
                      ...
                      id="spsa_sf_eps"
                      class="form-control"
                      value="${args.get('spsa', {}).get('sf_eps', '1e-8')}"
                    >
                  </div>
                </div>
              </div>
