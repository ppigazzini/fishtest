...
async def _dispatch_view(
    ...
    if request.method == "GET":
        ...
        # for the same URL based on the HX-Request and HX-Request-Type headers.
...
def live_elo_update(request: _ViewContext) -> dict[str, Any]:
    ...
    # A truthy sprt_state is terminal; live_elo_fragment then emits the
    # out-of-band element that removes the poller.
