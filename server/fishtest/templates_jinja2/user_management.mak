  ...
  <div class="row g-3 mb-3">
    <div class="col-6 col-sm">
      <div class="card card-lg-sm text-center">
        ...
        <div class="card-body">
          <h4 class="card-title mb-0 monospace">{{ all_users | length }}</h4>
        </div>
      </div>
    </div>
    <div class="col-6 col-sm">
      <div class="card card-lg-sm text-center">
        ...
        <div class="card-body">
          <h4 class="card-title mb-0 monospace">{{ pending_users | length }}</h4>
        </div>
      </div>
    </div>
    <div class="col-6 col-sm">
      <div class="card card-lg-sm text-center">
        ...
        <div class="card-body">
          <h4 class="card-title mb-0 monospace">{{ blocked_users | length }}</h4>
        </div>
      </div>
    </div>
    <div class="col-6 col-sm">
      <div class="card card-lg-sm text-center">
        ...
        <div class="card-body">
          <h4 class="card-title mb-0 monospace">{{ idle_users | length }}</h4>
        </div>
      </div>
    </div>
    <div class="col-6 col-sm">
      <div class="card card-lg-sm text-center">
        ...
        <div class="card-body">
          <h4 class="card-title mb-0 monospace">{{ approvers_users | length }}</h4>
        </div>
      </div>
    </div>
  </div>
