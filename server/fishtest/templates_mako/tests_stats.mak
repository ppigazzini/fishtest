...
<%!
  ...
  nelo_divided_by_nt = fishtest.stats.LLRcalc.nelo_divided_by_nt
%>
...
<%
  ...
  games = games3
  sigma = stdev3
  pdf3_s = helpers.pdf_to_string(pdf3)
  ...
  stdev3_u = var3_u ** 0.5
  t3, var_t3 = helpers.t_conf(avg3, var3, skewness3, exkurt3)
  ...
  if has_pentanomial:
      ...
      pdf5_s = helpers.pdf_to_string(pdf5)
      ...
      t5, var_t5 = helpers.t_conf(avg5, var5, skewness5, exkurt5)
  ...
  if has_sprt:
      ...
      LLRjumps3 = helpers.list_to_string(
      ...
      if has_pentanomial:
          LLRjumps5 = helpers.list_to_string(
